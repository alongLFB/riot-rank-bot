...
<head>
    ...
    <style>
        ...
        * {
        ...
        .exporting th {
            background: #f8fafc !important;
            position: static !important; /* Fix sticky header glitch in html2canvas */
        }
        .exporting .progress-bar {
            background: #3b82f6 !important; /* Remove gradient */
        }
        .exporting .progress-wrapper {
            background: #e2e8f0 !important;
        }
    </style>
</head>
        ...
        function exportPDF() {
            ...
            setTimeout(() => {
                const opt = {
                    ...
                    html2canvas:  { scale: 2, backgroundColor: '#ffffff', useCORS: true, windowWidth: 1200 },
